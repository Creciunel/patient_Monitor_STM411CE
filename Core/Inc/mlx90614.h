...
#define MLX90614_TOMAX      (MLX90614_OP_EEPROM | 0x00) /* object temperature max register */
#define MLX90614_TOMIN      (MLX90614_OP_EEPROM | 0x01) /* object temperature min register */
...
void initMLX90614(I2C_HandleTypeDef *, uint8_t);
uint8_t MLX90614_WriteReg(uint8_t, uint16_t);
uint8_t MLX90614_ReadReg(uint8_t, uint16_t*);
uint8_t MLX90614_ReadTemp(uint8_t, float*);
